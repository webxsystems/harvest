...
$country = "USA";
$adults = 3;
$checkin_monthday = date("d");
$checkin_month = date("m");
$checkin_year = date("Y");

$checkout_monthday = date("d")+1;
$checkout_month = date("m");
$checkout_year = date("Y");
...
//	DisplayParseSelectorResult(TagFilter::ParseSelector("input[form],textarea[form],select[form],button[form],datalist[id]"));
	...
	$purifyoptions = array(
		"allowed_tags" => "img",
		"allowed_attrs" => array("img" => "src", "a" => "href,id", "div" => "class"),
		"required_attrs" => array("img" => "src", "a" => "href"),
		"allowed_classes" => array("div" => "allowedclass"),
